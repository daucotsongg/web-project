<?php
	...
	$sql_pro = "SELECT * FROM tbl_sanpham,tbl_danhmuc WHERE tbl_sanpham.id_danhmuc=tbl_danhmuc.id_danhmuc and tinhtrang='1' ORDER BY tbl_sanpham.id_sanpham DESC LIMIT $begin,8";
